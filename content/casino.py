...
_LOSSES = [
    ...
    "🎩 {player} засмотрелся, как Пан Жмыжко очаровывает крупье, и прозевал {bet} Z.",
    "🎩 Пан Жмыжко увёл девушку {player} прямо от рулетки. Расстроенный, тот слил {bet} Z.",
    "🎩 {player} спорил с Паном Жмыжко, кто круче, и на эмоциях просадил {bet} Z.",
]
