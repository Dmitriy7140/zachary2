...
from handlers import (admin, bets, cashier, companion, courier, fishing, inventory, loan, market,
                      minigames, pranks, registration, roulette, scammer, shop, stats, vovka, work)
